...
\begin{exercise}
	...
	\begin{exercise}
		...
		\begin{exercise}
			...
			\end{align*}
			But $u$ is just a dummy variable. So doesn't that second integral look a lot like $F(t)$? In other words, $H'(t)=0$. That means that $H$ is constant; it's always $pi/4$. That's a shock!
