...
\begin{exercise}
	...
	$$x_{\mathit{right}}(y) = \answer[given]{R+\sqrt{r^2-y^2}}, \quad x_{\mathit{left}}(y) = \answer[given]{R-\sqrt{r^2-y^2}}$$
	...
	\begin{exercise}
		...
		\begin{exercise}
			...
			On the other hand, imagine starting out with a plastic rod with a base of $\pi r^2$ and a length of $2\pi R$. Now try to bend it to form a donut (our solid torus). It wouldn't work out, right? It would crack because we started out with something straight and our donut is curved. But if this rod were made out of clay, we could deform it and get back out torus, because the volumes are exactly the same!
